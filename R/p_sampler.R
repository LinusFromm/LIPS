#' Sampler over the B_p-extension
...
#' @export
p_sampler <- function(A, y, n.samples = 1e5, n.chains = 4, n.burnin = 1e4, B = NULL, CPLB_idx = NULL, x.start = NULL, p = 0, ldelta = 0, w = 0, dist = "unif"){
  n = nrow(A)
  r = ncol(A)
